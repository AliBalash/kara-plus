...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payments', function (Blueprint $table) {
            ...
            $table->enum('payment_type', ['rental_fee', 'security_deposit', 'salik', 'salik_4_aed', 'salik_4_20_aed', 'salik_6_aed', 'salik_6_30_aed', 'salik_other_revenue', 'fine', 'parking', 'damage', 'discount', 'payment_back', 'carwash', 'fuel', 'no_deposit_fee'])->default('rental_fee'); // نوع پرداخت
