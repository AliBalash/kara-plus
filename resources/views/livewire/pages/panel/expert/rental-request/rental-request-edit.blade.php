            ...
            <div class="col-md-6">
                <div class="card mb-4 shadow-sm border-0">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        <div class="mb-3 mt-3" data-validation-field="phone">
                            ...
                            @if (!$selectedExistingCustomer && empty($customerPhoneSuggestions))
                                <div class="form-text mt-2">
                                    If this phone belongs to another saved customer, load that profile before saving so
                                    the contract is linked to the right customer.
                                </div>
                            @endif

                            @if ($selectedExistingCustomer && $selectedExistingCustomerId !== $originalCustomerId)
                                    ...
                                    <div class="d-flex flex-column flex-lg-row align-items-lg-start justify-content-between gap-3">
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="customer-match-card__hint mt-2">
                                                Saving this form will move the contract onto this saved customer profile.
                                            </div>
                                        </div>
                                        <button type="button" class="btn btn-sm btn-outline-primary align-self-start"
                                            wire:click="restoreContractCustomer">
                                            <i class="bx bx-undo me-1"></i>
                                            Restore Contract Customer
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold mb-1" for="depositCategoryEdit">Security Hold Instructions</label>
