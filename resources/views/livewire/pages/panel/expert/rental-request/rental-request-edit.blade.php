    ...
    <div class="row">
        ...
        @if (is_null($contract->user_id))
            <a class="btn btn-info fw-bold m-2" href="javascript:void(0);"
                onclick="if(confirm('Are you sure?')) { @this.assignToMe({{ $contract->id }}) }">
                Assign to Me <i class="bx bx-user-plus"></i>
            </a>
        @else
            <div class="col-lg-6 text-end">
                <a class="btn btn-danger fw-bold" href="javascript:void(0);"
                    onclick="if(confirm('Are you sure?')) { @this.changeStatusToReserve({{ $contract->id }}) }">
                    Set to Reserved <i class="bx bxs-log-in-circle"></i>
                </a>
            </div>
        @endif
    </div>
    ...
    <form wire:submit.prevent="submit">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card mb-4">
                    <h5 class="card-header">Contract Details</h5>
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        ...
                        <div class="input-group">
                            ...
                            <input type="datetime-local"
                                ...
                                min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" name="pickup_date"
                        ...
                        <div class="input-group">
                            ...
                            <input type="datetime-local"
                                ...
                                min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" name="return_date"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio"
                                        ...
                                        @if ($selected_insurance === 'ldw_insurance') checked @endif>
                        ...
                        <table class="table table-bordered">
                            @if ($contract)
                                @foreach ($contract->charges as $charge)
                                    <tr>
                                        <th>{{ $charge->title }}</th>
                                        <td>{{ number_format($charge->amount) }} AED</td>
                                    </tr>
                                @endforeach
                            @else
                                <!-- نمایش پیش‌فرض قبل از ذخیره‌سازی -->
                                <tr>
                                    <th>Base Rental Cost</th>
