                            ...
                            @if ($selectedModelId)
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select @error('availability') is-invalid @enderror"
                                        ...
                                        <option value="true" {{ $availability ? 'selected' : '' }}>Available</option>
                                        <option value="false" {{ !$availability ? 'selected' : '' }}>Not Available
                                        </option>
                                    </select>
                                    @error('availability')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('mileage') is-invalid @enderror"
                                        placeholder="Mileage" name="mileage" wire:model="mileage" min="0"
                                        required>
                                    @error('mileage')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="card-body demo-vertical-spacing demo-only-element">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select @error('passing_status') is-invalid @enderror"
                                    ...
                                    <option value="done" {{ $passing_status == 'done' ? 'selected' : '' }}>Done
                                    </option>
