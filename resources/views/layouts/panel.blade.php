...
<head>
    ...
    <!-- Vendors CSS -->
    <link rel="stylesheet"
        href="{{ asset('assets/panel/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/panel/assets/vendor/libs/apex-charts/apex-charts.css') }}" />
...
<body>
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            <!-- Menu -->
            @livewire('components.panel.aside')
            <!-- / Menu -->

            <!-- Layout container -->
            <div class="layout-page">
                <!-- Navbar -->
                @livewire('components.panel.header')
                <!-- / Navbar -->
                ...
                <div class="content-wrapper">
                    ...
                    <!-- Footer -->
                    @livewire('components.panel.footer')
                    <!-- / Footer -->
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('assets/panel/assets/vendor/libs/apex-charts/apexcharts.js') }}"></script>

    <!-- Main JS -->
    <script src="{{ asset('assets/panel/assets/js/main.js') }}"></script>

    <!-- Page JS -->
    <script src="{{ asset('assets/panel/assets/js/dashboards-analytics.js') }}"></script>
